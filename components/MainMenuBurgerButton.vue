<template>
  ...
  >
    <span :style="buttonStyle" class="hamburger-box">
      <span :style="layerStyle" class="hamburger-inner">
        <span :style="layerStyle" class="hamburger-inner__before"></span>
        <span :style="layerStyle" class="hamburger-inner__after"></span>
      </span>
    </span>
  </button>
</template>
